...
const copy = {
  pt: {
    ...
    resumeHref: "/Lucas_Pacheco_Curriculo.pdf",
    resumeDownload: "Lucas_Pacheco_Curriculo.pdf",
  ...
  en: {
    ...
    resumeHref: "/Lucas_Pacheco_Resume.pdf",
    resumeDownload: "Lucas_Pacheco_Resume.pdf",
      ...
      >
        ...
        <motion.div variants={itemVariants} className="mt-10 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
          ...
          <Button asChild size="lg" variant="outline">
            <a href="https://github.com/LaPachec" target="_blank" rel="noopener noreferrer">
              <GitBranch aria-hidden="true" size={18} />
              GitHub
            </a>
          </Button>
          <Button asChild size="lg" variant="ghost">
            <a href={text.resumeHref} download={text.resumeDownload}>
